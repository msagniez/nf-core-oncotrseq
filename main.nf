...
include { getGenomeAttribute      } from './subworkflows/local/utils_nfcore_oncotrseq_pipeline'
...
workflow NFCORE_ONCOTRSEQ {
    ...
    emit:
    multiqc_report = ONCOTRSEQ.out.multiqc_report // channel: /path/to/multiqc_report.html
}
/*
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    RUN MAIN WORKFLOW
...
workflow {
    ...
    PIPELINE_COMPLETION (
        ...
        params.monochrome_logs,
        params.hook_url,
        NFCORE_ONCOTRSEQ.out.multiqc_report
    )
}
